...
import { Building2, Edit, Trash2, ChevronLeft, ChevronRight } from "lucide-react"
...
export const ImageCard = () => {
  ...
  const [quantityImages, setQuantityImages] = useState<number>(1)
  ...
  useEffect(() => {
    const handleData = async () => {
      ...
      const getImages = async () => {
        ...
        setQuantityImages(data.quantity)
      ...
      <div className="flex items-center justify-center gap-2 pt-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs text-gray-500">
            {`(Mostrando ${images.length} de ${quantityImages} imagens)`}
          </span>
        </div>
